...
BATCH_SIZE = 32
IMAGE_SIZE = [224,224]
BASE_DIR = 'C:\\Users\\hanif\\OneDrive\\Bureau\\CNN\\cnn'
...
print(df['gender'])
print(df)
df['gender'] = df['gender'].replace({0: 'homme', 1: 'femme'})
...
# Convertir les valeurs "homme" en 0 et "femme" en 1 dans y_true
y_true = test_df['gender'].replace({'homme': 0, 'femme': 1}).values
print (y_true)
# Convertir les pourcentages en classe prédite
